class Sudoku 
{
    ...
    static generate(n)
    {
        ...
        {
            const closeCell = Sudoku.getCloseCell(s)
            closeCell.number = 0
        }
    ...
    getHTML (size)
    {
        ...
        rootElement.style.position =`center`
    ...
    viewUpdate()
    {
        for (const cell of this.body)
        {
            cell.element.classList.remove("error-cell","important-cell", "supported-cell", "selected-cell")
